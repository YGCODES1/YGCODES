...
DİKKAT:BU UYGULAMA YGCODES VE TASARIMDA KATKISI OLANLARA AİTTİR İZİNSİZ DAĞITILMAZ VE KOPYALANAMAZ !!  ====================================

WARNİNG:  THIS APPLICATION BELONGS TO YGCODES AND THOSE WHO CONTRIBUTED TO ITS DESIGN. IT CANNOT BE DISTRIBUTED OR COPIED WITHOUT PERMISSION!! ===================



TEST TİME: NİGHT 3:45
BUİLDİNG: C LANG
